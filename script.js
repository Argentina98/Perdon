...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = '¿Piensa en Panchito?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 14:
            ...
            document.getElementById('noBtn').innerHTML = 'NO... ya di que si por panchito';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = 'por favooooooor Francisquita';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
